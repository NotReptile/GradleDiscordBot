package Reptile.GradleDiscordBot;

import Reptile.GradleDiscordBot.command.ICommand;
import Reptile.GradleDiscordBot.command.CommandContext;
import Reptile.GradleDiscordBot.command.commands.PingCmd;
import Reptile.GradleDiscordBot.command.commands.music.*;
...
public class CommandManager {
    ...
    public CommandManager() {
        ...
        addCommand(new RepeatCmd());
        addCommand(new LeaveCmd());
        addCommand(new PauseCmd());
        addCommand(new ResumeCmd());
    }
